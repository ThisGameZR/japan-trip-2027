...
export const budgetSectionInputs: BudgetSectionInput[] = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        subtitle: 'เรียวกังญี่ปุ่นแท้ แช่ออนเซ็นธรรมชาติพร้อมวิวฟูจิซัง คืนที่ 5 (20 ก.พ.)',
        thb: 2_500,
      },
      {
        title: 'โรงแรม The Gate Hotel Ryogoku (3 คืน)',
        subtitle: 'ที่พักย่านริวโกคุ คืนที่ 6–8 (21–23 ก.พ.)',
        thb: 9_000,
      },
    ],
  },
